...
describe('authenticated mission synchronization', () => {
  it(
    'projects an authoritative timed mission upsert into Calendar and search read models',
    async () => {
  ...
  it(
    'projects MTS-045 all-day, Private, location, and personal-note data on another device',
    async () => {
      const database = createDatabase();
      await applyMobileMigrations(database);
      const accountId = '11111111-1111-4111-8111-111111111111';
