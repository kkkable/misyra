/**
 * Build script for @misyra/localization.
 *
...
if (compile.status !== 0) {
  process.stderr.write(`@misyra/localization ${noEmit ? "typecheck" : "build"} failed\n`);
  process.exit(compile.status ?? 1);
}
process.stdout.write(`@misyra/localization ${noEmit ? "typecheck" : "build"} ok\n`);
