/**
 * Build script for @misyra/testing.
 *
...
if (compile.status !== 0) {
  process.stderr.write(`@misyra/testing ${noEmit ? "typecheck" : "build"} failed\n`);
  process.exit(compile.status ?? 1);
}
process.stdout.write(`@misyra/testing ${noEmit ? "typecheck" : "build"} ok\n`);
