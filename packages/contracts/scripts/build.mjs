/**
 * Build script for @misyra/contracts.
 *
...
if (compile.status !== 0) {
  process.stderr.write(`@misyra/contracts ${noEmit ? "typecheck" : "build"} failed\n`);
  process.exit(compile.status ?? 1);
}
process.stdout.write(`@misyra/contracts ${noEmit ? "typecheck" : "build"} ok\n`);
